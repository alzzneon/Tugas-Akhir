...
export default function RentalStatuses() {
  const nav = useNavigate();
  const endpoint = "/api/admin/masters/rental-statuses";
  ...
  const formFields = [
    { key: "code", label: "Code", required: true, placeholder: "BOOKED" },
    { key: "name", label: "Nama", required: true, placeholder: "Booked" },
  ...
  return (
    <div>
      ...
      <Modal
        open={open}
        size="md"
        title={mode === "create" ? "Tambah Status Rental" : "Edit Status Rental"}
